...
public class FormulaTest {
    ...
    public void testOr004() {
    	...
    	assertEquals(firstClause, makeClause(a, c));
    	assertEquals(secondClause, makeClause(b, c));
    	assertEquals(thirdClause, makeClause(a, d));
    	assertEquals(lastClause, makeClause(b, d));
